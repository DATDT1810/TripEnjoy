...
namespace TripEnjoy.Application.Interface.Room
{
    public interface IRoomService
    {
        ...
        Task<IEnumerable<Domain.Models.Room>> GetRoomsPartner(string email);
        //    Task<IEnumerable<TripEnjoy.Domain.Models.Room>> GetRoomsByPartnerEmailAsync(string email);
    }
}
